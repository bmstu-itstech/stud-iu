      ...
      <div className="flex flex-col lg:flex-row flex-1 gap-10 overflow-visible lg:overflow-hidden">
        <div className="w-full lg:w-1/2 bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 shadow-sm flex flex-col gap-6 overflow-y-auto border border-gray-200 h-auto lg:h-full">
          <input
            ...
            className="p-6 bg-gray-50 rounded-2xl text-xl font-bold outline-none focus:ring-2 focus:ring-blue-500/20"
            placeholder="ФИО"
          />
          <input
            {...register("position", { required: true })}
            className="p-6 bg-gray-50 rounded-2xl text-xl font-medium outline-none focus:ring-2 focus:ring-blue-500/20"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <input
              ...
              className="p-6 bg-gray-50 rounded-2xl text-lg font-medium outline-none"
          ...
          <textarea
            ...
            className="p-6 bg-gray-50 rounded-2xl text-lg min-h-[140px] outline-none resize-none"
        ...
        <div className="hidden xl:flex w-1/2 bg-gradient-to-b from-gray-900 to-blue-900 rounded-[2.5rem] p-10 items-center justify-center relative shadow-2xl">
          <div className="absolute top-8 right-8 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full text-xs font-bold text-white tracking-widest uppercase">
            PREVIEW
          </div>
