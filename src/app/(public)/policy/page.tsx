        ...
        <div className="flex flex-col gap-6 text-gray-800 bg-white p-8 sm:p-12 rounded-[2.5rem] shadow-sm">
          ...
          <div>
            ...
            <Text level={4} className="leading-relaxed">
              ...
              адрес электронной почты studsovetiu@yandex.ru с пометкой «Отказ от
          ...
          <div>
            ...
            <Text level={4} className="leading-relaxed">
              ...
              Оператора studsovetiu@yandex.ru с пометкой «Актуализация
              персональных данных».
              <br />
              ...
              studsovetiu@yandex.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
              <br />
