    ...
    return (
      ...
      >
        <div className="flex flex-col gap-3 text-white p-6 sm:p-8 flex-1 justify-center min-w-0">
          ...
          <Caption
            level={2}
            className="line-clamp-2 text-white/80 !text-sm sm:!text-base leading-snug"
          >
            {props.description}
          </Caption>
        </div>
    ...
    return (
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 flex flex-col gap-2">
          <Title
            level={4}
            className="text-white leading-tight line-clamp-2 drop-shadow-md"
          >
            {props.name}
          </Title>
        </div>
  ...
  return (
    ...
    >
      <div className="h-110 relative w-full">
        ...
        <Title
          level={4}
          className="absolute top-8 left-8 text-white z-20 max-w-[85%] break-words leading-tight"
        >
          {props.name}
        </Title>
      ...
      <div className="p-8 bg-gray-50 min-h-35">
        <Caption
          level={2}
          className="text-gray-600 line-clamp-3 break-words text-base leading-relaxed"
        >
          {props.description}
        </Caption>
      </div>
