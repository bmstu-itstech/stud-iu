      ...
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        <div className="flex flex-col gap-8 order-2 lg:order-1">
          ...
          <Text level={4} className="text-gray-600">
            Работаем над развитием IT-сообщества в стенах МГТУ им. Н.Э.
            Баумана в команде из 250 человек. На протяжении 3 лет Студенческий
            совет ИУ объединяет инициативных, креативных и горящих своим
            делом студентов, готовых разрабатывать новые проекты и
